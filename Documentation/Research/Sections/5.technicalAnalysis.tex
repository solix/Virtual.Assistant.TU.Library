...
In order to be sure that each item backlog implemented correctly, We re-define the definition of done to more specifically. When we say a functionality or the whole application is done we mean that It's: 
