\chapter{Features}
This section will walk the reader through various features of the application. These features has been developed in accordance with the functional and usability requirement \ref{requirements}. It is meant to provide the end-user of the application with necessary 
