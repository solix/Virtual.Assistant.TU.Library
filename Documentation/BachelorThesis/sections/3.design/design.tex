...
The View part of the MVC architecture is the gate for the user to interact with the application. The design of the View layer is designed to be simple
...
The Controllers are the brain of the application. They handle all the requests committed by users from the view part, and responds to it accordingly.
The Controller are also responsible to update the models if there is any change in the state of the information.