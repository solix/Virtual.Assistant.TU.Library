...
\vspace{0.3cm}
		...
		\vspace{0.3cm}
			\Large{\fontfamily{lmr}\selectfont \textbf{Reflection Sprint 6}}\\
		\vspace{0.3cm}	
...
\begin{center}
    ...
    \hline
    \multicolumn{7}{ |c| }{Sprint 6} \\
    \hline
    \textbf{Task} & \textbf{Subtasks} & \textbf{Estimated} & \textbf{Actual} & \textbf{Done} & \textbf{Tested} & \textbf{Remarks} \\ \hline
    Discussions & - & 6 & ? & $\times$ & $\times$ & Created basic discussion functionality that only supported main messages, no sub comments. Used available sample as a seed. \\ \hline
    Calendar & Event Model and Integrate JQuery & 6 & 6 & $\checkmark$ & $\times$ & lots of trial and error but succeeded \\ \hline
    \end{tabular}
\end{center}
...
\begin{itemize}
	...
	\item Coloring different event was time consuming and is lefted out for future features.
...
\begin{itemize}
	\item two sided Sync event with 
\end{itemize}
