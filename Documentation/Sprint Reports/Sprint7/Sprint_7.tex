...
\vspace{0.3cm}
		...
		\vspace{0.3cm}
			\Large{\fontfamily{lmr}\selectfont \textbf{Reflection Sprint 7}}\\
		\vspace{0.3cm}	
...
\begin{center}
    ...
    Calendar & Synch two sided  & 6 & 6 & $\times$ & $\times$ & REMARKS due to exam half done, only events created and saved from client side but could not render back \\ \hline
    \end{tabular}
\end{center}
...
\begin{itemize}
	...
	\item It was not very streight forward to make a communication with javascipt objects on client side and mapping it to the model, but this syncing is implemented 
...
\begin{itemize}
	\item Make a syncing of events back to calendar view using JSON
\end{itemize}
