...
\vspace{0.3cm}
		...
		\vspace{0.3cm}
			\Large{\fontfamily{lmr}\selectfont \textbf{Reflection Sprint 5}}\\
		\vspace{0.3cm}	
...
\begin{center}
    ...
    \hline
    \multicolumn{7}{ |c| }{Sprint 5} \\
    \hline
    \textbf{Task} & \textbf{Subtasks} & \textbf{Estimated} & \textbf{Actual} & \textbf{Done} & \textbf{Tested} & \textbf{Remarks} \\ \hline
    Suggestions \& tips & - & 6 & 3 & \checkmark & \checkmark & Used Jquery snippet \\ \hline
     Task & - & 6 & 6 & $\times$ & $\times$ & most of the part is done except datepicker \\ 
       
    \hline
    Mandeley OAth2 Login & - & 3 & 2 & \checkmark & \checkmark & login can now be done via mandeley as well \\ 
       
    \hline

   TUD OAth2 Login & - & 3 & - & $\times$ & $\times$ & due to security reason TU Delft ict refused to make an account for us \\ 
...
\begin{itemize}
	...
	\item we have stopped implementation fior TUD login, lost lots of time on last sprint
	\item Integrating datetime picker cost alot time, that created delay on making task section done ontime
