 ...
 */
public class MendeleyAuthUser extends BasicOAuth2AuthUser implements
    ...
    public MendeleyAuthUser(final JsonNode node, final OAuth2AuthInfo info,
                         final String state) {
        ...
        if (contactNode != null) {
            ...
            final Iterator<Map.Entry<String, JsonNode>> fieldIterator = contactNode.fields();
