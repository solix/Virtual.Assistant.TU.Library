...
import plugins.com.feth.play.module.mail.Mailer.Mail.Body;
...
//				return Messages.get("playauthenticate.password.signup.error.passwords_not_same");
	...
	protected UsernamePasswordAuthProvider.SignupResult signupUser(final LocalUsernamePasswordAuthUser user) {
	...
	protected static String generateVerificationRecord(final Person person) {
	...
	protected static String getVerifyEmailMailingSubjectAfterSignup(final Person person,
															 final Context ctx) {
		return Messages.get("[Verify your email] assisTU Web application");
	}
	...
	public static void sendVerifyEmailMailingAfterSignup(final Person person,
												  final Context ctx) {
