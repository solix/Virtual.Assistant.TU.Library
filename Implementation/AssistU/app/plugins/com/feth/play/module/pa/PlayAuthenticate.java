package plugins.com.feth.play.module.pa;
...
import plugins.com.feth.play.module.pa.service.UserService;
...
public abstract class PlayAuthenticate {
	...
	public abstract static class Resolver {
		 ...
		 * plugins.module.pa.controllers.AuthenticateController.
		 * authenticate(String)
		 ...
		 *
		 * @param provider
		 *            The provider ID matching one of your registered plugins.providers
		 *            in play.plugins
		 *
	...
	public static String getOriginalUrl(final Context context) {
		return context.session().remove(PlayAuthenticate.ORIGINAL_URL);
	}

	public static String storeOriginalUrl(final Context context) {
